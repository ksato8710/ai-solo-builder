...
slug: "figma-claude-code-integration-2026-02-18"
...
contentType: news
tags: ["product-update", "Figma", "Claude", "MCP"]
...
readTime: 3
relatedProducts: ["claude-code", "claude"]
---
...
- [Claude](/products/claude) - Anthropicの対話型AI
