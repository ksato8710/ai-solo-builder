...
contentType: "product"
type: product
description: "VS Codeベースの次世代AIコードエディタ。コードベース全体を理解した上でのインライン編集、Composerによるマルチファイル生成、Tab補完など、開発者の生産性を10倍に。"
readTime: 12
...
自然言語でプロジェクト全体への変更を指示。「ログイン機能を追加して」と言えば、複数ファイル（コンポーネント、API、型定義）を一括生成・編集。最も差別化された機能。
